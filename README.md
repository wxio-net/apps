...
1. **下载解压**
   ...
   从 https://github.com/wxio-net/apps/releases 下载最新版 `YouliYouli_mac_x64.zip`，双击解压后会得到 **`YouliYouli.app`**。将 `YouliYouli.app` 拖入 **访达** → **应用程序** 文件夹。

2. **首次打开**  

   若系统提示**应用已损坏**，请在 **终端** 执行（路径为你实际放置 `.app` 的位置）：
   ```bash
